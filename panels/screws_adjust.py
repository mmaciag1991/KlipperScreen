...
class Panel(ScreenPanel):
    ...
    def __init__(self, screen, title):
        ...
        self.buttons = {
            ...
            'CANCEL': self._gtk.Button("cancel", _("Przerwij"), "color2"),
            'NOW_ADJUSTED': self._gtk.Button("arrow-right", _("Ta śruba jest teraz wyregulowana"), "color4"),
            'ALREADY_ADJUSTED': self._gtk.Button("arrow-right", _("Ta śruba jest już wyregulowana"), "color4"),
            'FINISH': self._gtk.Button("complete", _("Zakończ"), "color2"),
        }
        ...
        self.labels['screws-adjust'] = Gtk.Grid()
